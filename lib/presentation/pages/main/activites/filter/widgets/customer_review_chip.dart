...
class CustomerReviewChip extends StatelessWidget {
  final String title;
  final VoidCallback onTap;
  final bool isSelected;

  const CustomerReviewChip({Key? key,required this.onTap,required this.isSelected,required this.title}) : super(key: key);
