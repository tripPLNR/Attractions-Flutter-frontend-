    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          ListView.builder(
            itemCount: site.inclusions?.length,
            shrinkWrap: true,
            ...
            itemBuilder: (context,index){
              return Padding(
                ...
                child: Row(
                  children: [
                    SvgPicture.asset(AppAssets.includes,height: 24.h,width: 24.w,),
                    SizedBox(width: 6.w,),
                    SizedBox(
                        width: 1.sw-80.w,
                        child: Text("${site.inclusions?[index].otherDescription}",style: AppStyle.headingH3(context),)),
                  ],
                ),
              );
            },
